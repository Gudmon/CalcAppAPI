...
namespace CalcAppAPI.Migrations
{
    ...
    [Migration("20260422072059_20260422 rotatorhydropack")]
    partial class _20260422rotatorhydropack
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CalcAppAPI.Models.Machine.Configurations.Palms.Cranes.Crane", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SupportBracketId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CalcAppAPI.Models.Machine.Configurations.Palms.Cranes.SupportBracket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CalcAppAPI.Models.Machine.Configurations.Palms.Trailers.ManualBunkExtension", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CalcAppAPI.Models.Machine.Configurations.Palms.Trailers.Toolbox", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CalcAppAPI.Models.Machine.Configurations.Palms.Trailers.Trailer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ManualBunkExtensionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ManualBunkExtensionId");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            HandBrakeId = 1,
                            HayBaleFrameId = 1,
                            ImageUrls = "[\"PALMS-10D-1\",\"PALMS-10D-2\",\"PALMS-10D-3\",\"PALMS-10D-4\",\"PALMS-10D-5\",\"Patented-Bolster-Lock\",\"Fast-Drawbar-Locking\",\"Extended-Product-Lifespan\",\"Durable-Double-Frame\",\"Protected\"]",
                        ...
                        new
                        {
                            ...
                            HandBrakeId = 1,
                            HayBaleFrameId = 1,
                            ImageUrls = "[\"PALMS-12D-1\",\"PALMS-12D-2\",\"Patented-Bolster-Lock\",\"Fast-Drawbar-Locking\",\"Extended-Product-Lifespan\",\"Durable-Double-Frame\",\"Protected\"]",
                        ...
                        new
                        {
                            ...
                            HandBrakeId = 1,
                            HayBaleFrameId = 1,
                            ImageUrls = "[\"PALMS-14D-1\",\"PALMS-14D-2\",\"PALMS-14D-3\",\"PALMS-14D-4\",\"Patented-Bolster-Lock\",\"Fast-Drawbar-Locking\",\"Extended-Product-Lifespan\",\"Durable-Double-Frame\",\"Protected\"]",
                        ...
                        new
                        {
                            ...
                            HandBrakeId = 1,
                            HayBaleFrameId = 2,
                            ImageUrls = "[\"PALMS-10UX-1\",\"PALMS-10UX-2\",\"Fast-Drawbar-Locking\",\"Extended-Product-Lifespan\",\"Easy-Access\",\"Reduced-Weight\",\"Easily-Replaceable\",\"Stronger-And-Stiffer\",\"Multiple-Bolster\",\"Uniform-Frame-Bottom\",\"Available-With\",\"Centralized-Greasing\"]",
                            LoadingAreaCross = "2.4",
                            LoadingAreaLength = "3990",
                            MOTId = 1,
                            ManualBunkExtensionId = 1,
                            MaxCraneSize = "90",
                            Name = "PALMS 10UX",
                            Price = "",
                            ShippingId = 1,
                        ...
                        new
                        {
                            ...
                            HandBrakeId = 1,
                            HayBaleFrameId = 2,
                            ImageUrls = "[\"PALMS-12U-UAWD-1\",\"PALMS-12U-UAWD-2\",\"Fast-Drawbar-Locking\",\"Extended-Product-Lifespan\",\"Easy-Access\",\"Reduced-Weight\",\"Easily-Replaceable\",\"Stronger-And-Stiffer\",\"Multiple-Bolster\",\"Uniform-Frame-Bottom\",\"Available-With\",\"Centralized-Greasing\"]",
                        ...
                        new
                        {
                            ...
                            HandBrakeId = 1,
                            HayBaleFrameId = 2,
                            ImageUrls = "[\"PALMS-15U-UAWD-1\",\"PALMS-15U-UAWD-2\",\"Fast-Drawbar-Locking\",\"Extended-Product-Lifespan\",\"Easy-Access\",\"Reduced-Weight\",\"Easily-Replaceable\",\"Stronger-And-Stiffer\",\"Multiple-Bolster\",\"Uniform-Frame-Bottom\",\"Available-With\",\"Centralized-Greasing\"]",
                        ...
                        new
                        {
                            ...
                            HandBrakeId = 1,
                            HayBaleFrameId = 1,
                            ImageUrls = "[\"PALMS-11UX-1\",\"PALMS-11UX-2\",\"PALMS-11UX-3\",\"PALMS-11UX-4\",\"PALMS-11UX-5\",\"PALMS-11UX-6\",\"PALMS-11UX-7\",\"PALMS-11UX-8\"]",
            ...
            modelBuilder.Entity("CalcAppAPI.Models.Machine.Configurations.Palms.Trailers.TrailerLight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrailerTrailerLight", b =>
                {
                    b.Property<int>("LightId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BrakeTrailer", b =>
                {
                    ...
                    b.HasOne("CalcAppAPI.Models.Machine.Configurations.Palms.Trailers.Trailer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CalcAppAPI.Models.Machine.Configurations.Palms.Cranes.Crane", b =>
                {
                    ...
                    b.HasOne("CalcAppAPI.Models.Machine.Configurations.Palms.Cranes.SupportBracket", "SupportBracket")
                        .WithMany("Crane")
                        .HasForeignKey("SupportBracketId");
            ...
            modelBuilder.Entity("CalcAppAPI.Models.Machine.Configurations.Palms.Trailers.Trailer", b =>
                {
                    ...
                    b.HasOne("CalcAppAPI.Models.Machine.Configurations.Palms.Trailers.ManualBunkExtension", "ManualBunkExtension")
                        .WithMany("Trailer")
                        .HasForeignKey("ManualBunkExtensionId");
                    ...
                    b.HasOne("CalcAppAPI.Models.Machine.Configurations.Palms.Trailers.Toolbox", "Toolbox")
                        .WithMany("Trailer")
                    ...
                    b.Navigation("ManualBunkExtension");
            ...
            modelBuilder.Entity("ControlBlockCrane", b =>
                {
                    ...
                    b.HasOne("CalcAppAPI.Models.Machine.Configurations.Palms.Cranes.Crane", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TrailerTrailerLight", b =>
                {
                    b.HasOne("CalcAppAPI.Models.Machine.Configurations.Palms.Trailers.TrailerLight", null)
                        .WithMany()
                        .HasForeignKey("LightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
