            ...
            modelBuilder.Entity<Crane>()
                ...
                .UsingEntity(j => j.ToTable("GrappleCrane")
                    ...
                    (
                        ...
                        new { CraneId = 4, GrappleId = 5 },
                        new { CraneId = 4, GrappleId = 8 },
                        ...
                        new { CraneId = 5, GrappleId = 5 },
                        new { CraneId = 5, GrappleId = 8 },
                        ...
                        new { CraneId = 9, GrappleId = 12 },
                        new { CraneId = 9, GrappleId = 14 },
                        ...
                        new { CraneId = 10, GrappleId = 12 },
                        new { CraneId = 10, GrappleId = 14 },
                        ...
                        new { CraneId = 11, GrappleId = 12 },
                        new { CraneId = 11, GrappleId = 14 },
                        ...
                        new { CraneId = 12, GrappleId = 12 },
                        new { CraneId = 12, GrappleId = 14 },

                        //PALMS 1.42
                        new { CraneId = 13, GrappleId = 15 }
                    )
                );
        }
    }
